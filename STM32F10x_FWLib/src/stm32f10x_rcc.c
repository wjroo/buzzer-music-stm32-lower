...
void RCC_HSICmd(FunctionalState NewState) {
    ...
    *(__IO
    uint32_t *) CR_HSION_BB = (uint32_t) NewState;
}
...
void RCC_PLLCmd(FunctionalState NewState) {
    ...
    *(__IO
    uint32_t *) CR_PLLON_BB = (uint32_t) NewState;
}
...
void RCC_ITConfig(uint8_t RCC_IT, FunctionalState NewState) {
    ...
    if (NewState != DISABLE) {
        ...
        *(__IO
        uint8_t *) CIR_BYTE2_ADDRESS |= RCC_IT;
    } else {
        /* Perform Byte access to RCC_CIR bits to disable the selected interrupts */
        *(__IO
        uint8_t *) CIR_BYTE2_ADDRESS &= (uint8_t)
        ~RCC_IT;
    }
}
...
void RCC_USBCLKConfig(uint32_t RCC_USBCLKSource) {
    ...
    *(__IO
    uint32_t *) CFGR_USBPRE_BB = RCC_USBCLKSource;
}
...
void RCC_LSEConfig(uint8_t RCC_LSE) {
    ...
    /* Reset LSEON bit */
    *(__IO
    uint8_t *) BDCR_ADDRESS = RCC_LSE_OFF;
    /* Reset LSEBYP bit */
    *(__IO
    uint8_t *) BDCR_ADDRESS = RCC_LSE_OFF;
    ...
    switch (RCC_LSE) {
        case RCC_LSE_ON:
            /* Set LSEON bit */
            *(__IO
            uint8_t *) BDCR_ADDRESS = RCC_LSE_ON;
            break;

        case RCC_LSE_Bypass:
            /* Set LSEBYP and LSEON bits */
            *(__IO
            uint8_t *) BDCR_ADDRESS = RCC_LSE_Bypass | RCC_LSE_ON;
            break;
...
void RCC_LSICmd(FunctionalState NewState) {
    ...
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(__IO
    uint32_t *) CSR_LSION_BB = (uint32_t) NewState;
}
...
void RCC_RTCCLKCmd(FunctionalState NewState) {
    ...
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(__IO
    uint32_t *) BDCR_RTCEN_BB = (uint32_t) NewState;
}
...
void RCC_BackupResetCmd(FunctionalState NewState) {
    ...
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(__IO
    uint32_t *) BDCR_BDRST_BB = (uint32_t) NewState;
}
...
void RCC_ClockSecuritySystemCmd(FunctionalState NewState) {
    ...
    assert_param(IS_FUNCTIONAL_STATE(NewState));
    *(__IO
    uint32_t *) CR_CSSON_BB = (uint32_t) NewState;
}
...
void RCC_MCOConfig(uint8_t RCC_MCO) {
    ...
    *(__IO
    uint8_t *) CFGR_BYTE4_ADDRESS = RCC_MCO;
}
...
void RCC_ClearITPendingBit(uint8_t RCC_IT) {
    ...
    /* Perform Byte access to RCC_CIR[23:16] bits to clear the selected interrupt
       pending bits */
    *(__IO
    uint8_t *) CIR_BYTE3_ADDRESS = RCC_IT;
}
