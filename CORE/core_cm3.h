 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE void NVIC_SetPendingIRQ(IRQn_Type
IRQn)
{
 ...
 * The interrupt number cannot be a negative value.
 */
static __INLINE void NVIC_ClearPendingIRQ(IRQn_Type
IRQn)
{
 ...
 */
static __INLINE void NVIC_SetPriority(IRQn_Type
IRQn,
uint32_t priority
)
{
 ...
 */
static __INLINE void NVIC_DecodePriority(uint32_t
Priority,
...
SysTick->
LOAD = (ticks & SysTick_LOAD_RELOAD_Msk) - 1;      /* set reload register */
